...
/* 34 */             pipeline.addLast((ChannelHandler)new MictrackProtocolDecoder((Protocol)MictrackProtocol.this));
/*    */           }
/*    */         });
...
/* 42 */             pipeline.addLast((ChannelHandler)new MictrackProtocolDecoder((Protocol)MictrackProtocol.this));
/*    */           }
/*    */         });
/*    */   }
/*    */ }
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\org\traccar\protocol\MictrackProtocol.class
