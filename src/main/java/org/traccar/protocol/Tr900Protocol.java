...
/* 34 */             pipeline.addLast((ChannelHandler)new Tr900ProtocolDecoder((Protocol)Tr900Protocol.this));
/*    */           }
/*    */         });
...
/* 42 */             pipeline.addLast((ChannelHandler)new Tr900ProtocolDecoder((Protocol)Tr900Protocol.this));
/*    */           }
/*    */         });
/*    */   }
/*    */ }
...
/* Location:              C:\User\\user\Documents\Ensurity Mobile [Client]\Latest App\traccar\tracker-server.jar!\org\traccar\protocol\Tr900Protocol.class
